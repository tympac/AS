...
<div class="pageoverflow">
	<p class="pagetext">{$frmbld->lang('title_select_udt_handler')}:</p>
	<p class="pageinput">
    <select name="{$actionid}udt_handler_pref">
      {html_options options = $udts_handlers_list selected = $udt_handler_pref}
    </select>
  </p>
</div>
<div class="pageoverflow">
