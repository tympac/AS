<?php
/* Smarty version 4.3.4, created on 2025-04-18 18:18:39
  from 'C:\xampp\htdocs\homefinder\app\views\templates\properties.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_68027b5f385330_08425243',
...
function content_68027b5f385330_08425243 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="http://localhost/homefinder/app/views/templates/assets/css/bootstrap.min.css">

    <link rel="stylesheet" type="text/css"
        href="http://localhost/homefinder/app/views/templates/assets/css/font-awesome.css">
...
properties">Properties</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                                    aria-haspopup="true" aria-expanded="false">My Properties</a>
...
logout">LOG OUT</a></li>
    ...
    <section class="section section-bg" id="call-to-action"
        style="background-image: url(http://localhost/homefinder/app/views/templates/assets/images/banner-image-1-1920x500.jpg)">
        <div class="container">
            <div class="row">
    ...
    <section class="section" id="trainers">
        <div class="container">
            ...
            <div class="contact-form">
                                <form id="searchForm" action="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_root;?>
properties" method="GET">

                    <div class="col-12">
                        <div class="form-group">
                            <label>Search option:</label>
                            <input type="text" name="sf_type"
                                value="<?php echo (($tmp = (($tmp = $_smarty_tpl->tpl_vars['searchForm']->value->type ?? null)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['searchType']->value ?? null : $tmp) ?? null)===null||$tmp==='' ? '' ?? null : $tmp);?>
">                         </div>
                    </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            <div class="down-content">
                                ...
                                <ul class="social-icons">
                                    <li><a href="http://localhost/app/views/templates/assets/property-details.html">+ View
                                            More</a></li>
                                </ul>
                            </div>
                        </div>
...
>
      $(function(){
  // Delegate the submit so it survives any DOM replacement elsewhere
  $(document).on('submit', '#searchForm', function(e){
    e.preventDefault();
    const $form = $(this);
    $.get($form.attr('action'), $form.serialize())
      .done(function(html){
        // Optionally log the fragment so you can debug
        // console.log('XHR response:', html);
        $('#results').replaceWith(html);
      })
      .fail(()=>{
        alert('Sorry—couldn’t load results.');
      });
  });

  // Your existing pagination handler can stay delegated too
