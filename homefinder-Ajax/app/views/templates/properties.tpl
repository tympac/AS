    ...
    <section class="section" id="trainers">
        <div class="container">
            ...
            <div class="contact-form">
                ...
                <form id="searchForm" action="{$conf->action_root}properties" method="GET">

                    <div class="col-12">
                        <div class="form-group">
                            <label>Search option:</label>
                            <input type="text" name="sf_type"
                                value="{$searchForm->type|default:$searchType|default:''}"> {* Also ensure value
                            persists *}
                        </div>
                    </div>
                ...
                <nav id="pagination">
                    <ul class="pagination pagination-lg justify-content-center">
                        <li class="page-item {if $page == 1}disabled{/if}">
                            <a class="page-link" href="{$conf->action_root}properties?page={$page-1}&sf_type={$searchType}"
                                aria-label="Previous">
